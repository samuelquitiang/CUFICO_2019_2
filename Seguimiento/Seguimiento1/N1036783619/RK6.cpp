...
int main()
{
    ...
    float x0=0.; //punto inicial
    float xf=5.; //punto final
    float y0=1.0;//condicion inicial
    float h=(xf-x0)/Numpuntos;//paso 
    
    //se definen las constantes del metodo
    float a21=1./3;
  ...
  //definimos los valores de ki
	...
	//escribimos los valores de x y y en el archivo
